...
export const uploaddelivery = environment.SERVER + "uploaddelivery"
...
export const importDeliveryFile = environment.SERVER + "importDeliveryFile"
// export const audiovPath = environment.audio  URL
