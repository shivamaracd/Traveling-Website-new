...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  public authkey: any = sessionStorage.getItem("token");
  ...
  constructor(@Inject(DOCUMENT) private document: Document, private renderer: Renderer2, private router: Router, public auth: AuthService) {
  ...
  ngOnInit(): void {
    // this.menuItems = MENU;
    this.menuItems = sessionStorage.getItem("type") == '2' ? COMPANY : MENU;
  ...
  onLogout(e: any) {
    ...
    if (!localStorage.getItem('isLoggedin')) {
      this.auth.logout(this.authkey).subscribe(
        res => {
          localStorage.clear();
